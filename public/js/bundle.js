...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHVuZ3V5ZW4xNiIsImEiOiJjbG8yeXV4dXQxOTA5MmpvMzF0eTFiZGdwIn0.0Ti-i79luTzbyqQH9xRw1g';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/tunguyen16/clo2yy0km00ia01qv4gwr3czj',
    // style URL
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error logout. Try again!');
        case 10:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', "Update ".concat(type, " successfully"));
            window.setTimeout(function () {
              location.reload(true);
            }, 1000);
          }
...
var updateInfoForm = document.querySelector('.form-user-data');
var updatePasswordForm = document.querySelector('.form-user-settings');
var logoutBtn = document.querySelector('.nav__el--logout');
var bookTourBtn = document.getElementById('book-tour');
if (mapBox) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40509" + '/');
